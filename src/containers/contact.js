        ...
        <Contact.Content>
          ...
          <Contact.Form autoComplete="off" onSubmit={sendEmail}>
            <Contact.LeftPane>
              ...
              <Contact.Input type='text' name='phone' placeholder='PHONE' value={phoneText} onChange={e => setPhoneText(e.target.value)} />
            </Contact.LeftPane>
            <Contact.RightPane>
              <Contact.Textarea placeholder='MESSAGE' name='message' value={messageText} onChange={e => setMessageText(e.target.value)} />
